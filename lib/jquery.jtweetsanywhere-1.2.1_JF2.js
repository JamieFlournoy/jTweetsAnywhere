...
(function($)
{
  ...
  defaultTweetReplyToDecorator = function(tweet, options)
	{
    var html = '';
    if (tweet.user && tweet.user.screen_name && tweet['id']) {
      var reply_url = 'http://twitter.com/?status=@' + tweet.user.screen_name + "%20&in_reply_to_status_id=" + tweet['id'] + "&in_reply_to=" + tweet.from_user;
